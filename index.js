...
var GitHubCrawler = function () {
    ...
    _createClass(GitHubCrawler, [{
         ...
         * @return {Object} json
         */
        value: async function getDataByTopic(topicName) {
            var result = [];

            var gitHubSearchPage = await _githubSearchPage.GitHubSearchPage.request('?q=topic:' + topicName);
            var repositories = gitHubSearchPage.getRepositories();

            repositories.forEach(async function (repository) {
                var title = repository.getTitle();
                var gitHubReleasePage = await _githubReleasePage.GitHubReleasePage.request(title);
                var gitHubReleases = gitHubReleasePage.getReleases();
                var releases = gitHubReleases.map(function (gitHubRelease) {
                    return {
...
},{"./pages/release/github-release-page":29,"./pages/search/github-search-page":32}],28:[function(require,module,exports){
'use strict';
...
var GitHubReleasePage = function (_GitHubDocument) {
    ...
    _createClass(GitHubReleasePage, [{
        ...
        key: 'request',
        value: async function request(repositoryLink) {
            var response = await _axios2.default.get('https://github.com' + repositoryLink + '/releases');
...
},{"../../pages/github-document":28,"../../pages/release/github-release":30,"axios":1}],30:[function(require,module,exports){
'use strict';
...
var GitHubSearchPage = function (_GitHubDocument) {
    ...
    _createClass(GitHubSearchPage, [{
        ...
        key: 'request',
        value: async function request(searchParams) {
            var response = await _axios2.default.get('https://github.com/search' + searchParams);
...
},{"../../pages/github-document":28,"../../pages/repository/github-repository":31,"axios":1}],33:[function(require,module,exports){
